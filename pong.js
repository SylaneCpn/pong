        ...
        function draw() {
            ...
            // Draw ball
            ctx.beginPath();
            ctx.arc(ballX, ballY, canvas.width * 0.01, 0, Math.PI * 2);
            ctx.fillStyle = "white";
            ctx.fill();
            ctx.closePath();
            ...
            if (ballY - canvas.width * 0.01 < 0 || ballY + canvas.width * 0.01 > canvas.height) {
                ballSpeedY = -ballSpeedY;
            }

            // Bounce off paddles
            if (
                (ballX - canvas.width * 0.01 < paddleWidth && ballY > leftPaddleY && ballY < leftPaddleY + leftPaddleHeight) ||
                (ballX + canvas.width * 0.01 > canvas.width - paddleWidth && ballY > rightPaddleY && ballY < rightPaddleY + rightPaddleHeight)
            ) {
